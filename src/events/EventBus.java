...
public class EventBus {
    ...
    private boolean isSubscriber(Method method) {
        ...
        boolean isSub = hasMethodAnnotation(method, Subscribe.class);
        ...
        for (Class i : interfaces) {
            try {
                ...
                if (interfaceMethod != null) {
                    isSub = hasMethodAnnotation(interfaceMethod, Subscribe.class);
                    if (isSub) return true;
                }
    ...
    public boolean hasMethodAnnotation(Method method, Class annotationClass) {
